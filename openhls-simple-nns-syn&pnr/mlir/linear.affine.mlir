module attributes {torch.debug_module_name = "Linear"} {
  ...
  func.func @forward(%arg0: memref<1x11xf32>) -> memref<f32> {
    ...
    affine.parallel (%arg1, %arg2) = (0, 0) to (11, 11) step (1, 1) {
    ...
    affine.parallel (%arg1, %arg2) = (0, 0) to (1, 11) step (1, 1) {
    ...
    affine.parallel (%arg1, %arg2) = (0, 0) to (1, 11) step (1, 1) {
      ...
      affine.for %arg3 = 0 to 11 step 1 {
    ...
    affine.for %arg1 = 0 to 1 step 1 {

      affine.for %arg2 = 0 to 11 step 1 {
